                ...
                <div className="mb-4">
                    <div className="relative">
                        ...
                        <input
                            ...
                            onChange={handleChange}
                            className="w-full pl-10 px-3 py-2 border-2 border-gray-400 rounded focus:outline-none focus:border-violet-600"
                            required
                        />
                    </div>
                ...
                <div className="mb-6">
                    <div className="relative">
                        ...
                        <input
                            ...
                            onChange={handleChange}
                            className={`w-full pl-10 px-3 py-2 border-2 rounded focus:outline-none ${errors.confirmPassword
                                ? "border-red-500"
